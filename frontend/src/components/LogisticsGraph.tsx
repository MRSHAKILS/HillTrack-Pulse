...
interface LogisticsGraphProps {
  sourceName?: string
}

const LogisticsGraph = ({ sourceName = 'Upazila Health Complex' }: LogisticsGraphProps) => {
      ...
      data: { 
        label: (
          <div className="text-center">
            <div className="text-xs font-bold text-green-800 mb-1">SOURCE</div>
            <div className="text-sm font-semibold">{sourceName}</div>
...
const initialEdges: Edge[] = [
  ...
  // Update nodes when sourceName changes
  useEffect(() => {
